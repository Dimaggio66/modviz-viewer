...
const SIDEBAR_MIN_WIDTH_PCT = 14;
const SIDEBAR_MAX_WIDTH_PCT = 60;
...
export function ViewerLayout() {
  ...
  const sidebarMode = useViewerStore((s) => s.sidebarMode);
  const sidebarWidthPct = useViewerStore((s) => s.sidebarWidthPct);
  ...
  useEffect(() => {
    const group = desktopPanelGroupRef.current;
    if (!group || typeof ResizeObserver === 'undefined') return;
    const update = () => setDesktopPanelGroupWidth(group.clientWidth);
    update();
  ...
  return (
    <TooltipProvider delay={300}>
      <div className="viewer-shell flex flex-col h-screen h-[100dvh] w-screen overflow-hidden bg-background text-foreground">
        {safeMode && (
            ...
            <div className="viewer-desktop-panels flex-1 min-h-0 flex">
              ...
              >
                ...
                >
                  ...
                  {/* Center - Viewport */}
                  <ResizablePanel id="viewport-panel" defaultSize="78%" minSize="30%">
                    ...
                    <div data-floating-snap-bounds className="viewer-viewport-frame h-full w-full overflow-hidden relative">
                      <ViewportContainer />
                    </div>
                  </ResizablePanel>
                  </ResizablePanelGroup>
